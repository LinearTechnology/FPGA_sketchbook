...
create_generated_clock -name sclk_u1 -source [get_ports adc_clk] -edges {1 2 3} -edge_shift {0.5 0.5 0.5}
create_generated_clock -name sclk_u2 -source [get_ports adc_clk] -edges {1 2 3} -edge_shift {0.5 0.5 0.5}
create_generated_clock -name sclk_filt_u1 -source [get_ports adc_clk] -edges {1 2 3} -edge_shift {0.5 0.5 0.5}
create_generated_clock -name sclk_filt_u2 -source [get_ports adc_clk] -edges {1 2 3} -edge_shift {0.5 0.5 0.5}
