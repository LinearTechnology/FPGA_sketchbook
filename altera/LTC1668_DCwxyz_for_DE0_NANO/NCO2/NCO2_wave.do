...
add wave -noupdate -format Logic -radix binary /NCO2_tb/clk
add wave -noupdate -format Logic -radix binary /NCO2_tb/reset_n
add wave -noupdate -format Logic -radix binary /NCO2_tb/clken
...
add wave -noupdate -format Logic -radix binary /NCO2_tb/out_valid
...
add wave -noupdate -color Yellow -format Analog-Step -radix decimal -scale 0.0010 /NCO2_tb/sin_val
